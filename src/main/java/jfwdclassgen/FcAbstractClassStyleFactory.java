...
final class FcAbstractClassStyleFactory
  ...
  public FcAbstractClassStyleFactory(final FcTypeElement element) {
  ...
  private MethodSpec forwardingMethod(final ExecutableElement methodElement) {
    final MethodSpec.Builder code = FcMethodSpec.overriding(methodElement);
